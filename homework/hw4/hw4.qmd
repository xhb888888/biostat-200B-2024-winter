...
-   For the moderate group: $\frac{-ln(2)}{(\hat{\beta_1} + \hat{\beta_4})}=\frac{-ln(2)}{-0.00488 + 0.00094844} = 176.30$

-   For the severe group: $\frac{-ln(2)}{(\hat{\beta_1} + \hat{\beta_5})}= \frac{-ln(2)}{-0.00488 - 0.00735} = 56.68$
