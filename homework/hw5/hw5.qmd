...
$VIF_j = \frac{1}{1 - R^2_j} = 3.82849$

$\hat{\sigma}^2 = MSE(F) = 0.08284$

$s^2_j=21.386$

We can calculate the SE using the formula:

$SE=\sqrt{\hat{Var}(\hat{\beta_j})}=\sqrt{\frac{1}{1-R^2_j}\frac{\hat{\sigma}^2}{(n-1)s^2_j}}=\sqrt{\frac{3.82849\times 0.08284}{(440-1)\times 21.386}}\approx 0.0066$
