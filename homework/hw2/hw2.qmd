...
$SSR=\sum(\hat{\beta_0}+\hat{\beta_1}X_i-\hat{\beta_0}-\hat{\beta_1}\bar{X})^2$
...
$\hat{\sigma^*}^2=\frac{1}{n-2}\sum(Y_i-\hat{Y_i})^2=\hat{\sigma}^2$
...
$\hat{\sigma^*}^2=\frac{1}{n-2}\sum(kY_i-\hat{Y_i^*})^2=\frac{k^2}{n-2}\sum(Y_i-\bar{Y_i})^2=k^2\hat{\sigma}^2$
...
$\hat{\sigma^*}^2=\frac{1}{n-2}\sum(Y_i+d-\hat{Y_i^*})^2=\frac{1}{n-2}\sum(Y_i+d-\hat{\beta_0}-d-\hat{\beta_1}X_i)^2=\frac{1}{n-2}\sum(Y_i-\hat{Y_i})^2=\hat{\sigma}^2$
